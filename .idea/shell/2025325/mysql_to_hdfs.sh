...
"all")
  ...
  import_data /opt/soft/datax/job/2207A/xinyi_jiao/import/dev_realtime_v1_xinyu_luo.activity_rule.json /2207A/xinyi_jiao/activity_rule/$do_date
  import_data /opt/soft/datax/job/2207A/xinyi_jiao/import/dev_realtime_v1_xinyu_luo.base_dic.json /2207A/xinyi_jiao/base_dic/$do_date
import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.order_info.json /2207A/xinyi_jiao/tms01/order_info/$do_date
  import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.order_cargo.json /2207A/xinyi_jiao/tms01/order_cargo/$do_date
  import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.base_dic.json /2207A/xinyi_jiao/tms01/base_dic/$do_date
  import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.base_complex.json /2207A/xinyi_jiao/tms01/base_complex/$do_date
  import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.base_region_info.json /2207A/xinyi_jiao/tms01/base_region_info/$do_date
  import_data /opt/soft/datax/job/xinyi_jiao/tms01/import/tms01.base_organ.json /2207A/xinyi_jiao/tms01/base_organ/$do_date 
  ;;
esac
